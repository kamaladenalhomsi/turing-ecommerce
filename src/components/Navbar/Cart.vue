      ...
      <div class="cart-modal__wrapper">
        <div class="w-10/12 mx-auto h-full">
          <div class="flex justify-between">
            ...
            >{{ activeTab === 0 ? cart_count : saved_count }} Items In Your {{ activeTab === 0 ? 'Cart' : 'Saved list' }}</h1>
        ...
        <div class="cart-modal__footer mt-8">
          <div class="w-10/12 h-full mx-auto flex items-center">
            ...
            <div class="w-1/2 flex justify-end" v-if="cart_count > 0 && activeTab === 0">
              ...
              <custom-button size="large" type="filled-fuchsia" class="ml-4">Checkout</custom-button>
            </div>
          </div>
        </div>
      </div>
